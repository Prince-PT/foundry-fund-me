...
contract FundMeTest is Test {
    ...
    function testMinimiumDollarFive() public view {
    ...
    function testFundFailWithoutEnoughtETH() public {
        ...
        fundMe.fund(); // Should revert because the value is less than MINIMUM_USD
    }
    ...
    function testOnlyOwnerCanWithdraw() public funded {
        ...
        vm.expectRevert(); // Hey, the next line should revert
        // assert(This tx fails/reverts)
        fundMe.withdraw(); // Should revert because the sender is not the owner
    }
